...
export default function Farms() {
  ...
  const cardData = [
    { 
      id:"id1",
      images:importAllImages(require.context('../../images/farms/deharadun', false, /\.(png|jpe?g|svg)$/)),
      imagearray1: Object.keys(importAllImages(require.context('../../images/farms/deharadun', false, /\.(png|jpe?g|svg)$/))),
    ...
    { 
      id:"id2",
      images:importAllImages(require.context('../../images/farms/girnare', false, /\.(png|jpe?g|svg)$/)),
      imagearray1: Object.keys(importAllImages(require.context('../../images/farms/girnare', false, /\.(png|jpe?g|svg)$/))),
    ...
    { 
      id:"id3",
      images:importAllImages(require.context('../../images/farms/gurugram', false, /\.(png|jpe?g|svg)$/)),
      imagearray1: Object.keys(importAllImages(require.context('../../images/farms/gurugram', false, /\.(png|jpe?g|svg)$/))),
    ...
    { 
      id:"id4",
      images:importAllImages(require.context('../../images/farms/jibhi', false, /\.(png|jpe?g|svg)$/)),
      imagearray1: Object.keys(importAllImages(require.context('../../images/farms/jibhi', false, /\.(png|jpe?g|svg)$/))),
    ...
    { 
      id:"id5",
      images:importAllImages(require.context('../../images/farms/kasol', false, /\.(png|jpe?g|svg)$/)),
      imagearray1: Object.keys(importAllImages(require.context('../../images/farms/kasol', false, /\.(png|jpe?g|svg)$/))),
    ...
    { 
      id:"id6",
      images:importAllImages(require.context('../../images/farms/manesar', false, /\.(png|jpe?g|svg)$/)),
      imagearray1: Object.keys(importAllImages(require.context('../../images/farms/manesar', false, /\.(png|jpe?g|svg)$/))),
    ...
    { 
      id:"id7",
      images:importAllImages(require.context('../../images/farms/phrog', false, /\.(png|jpe?g|svg)$/)),
      imagearray1: Object.keys(importAllImages(require.context('../../images/farms/phrog', false, /\.(png|jpe?g|svg)$/))),
    ...
    { 
      id:"id8",
      images:importAllImages(require.context('../../images/farms/Udaipur', false, /\.(png|jpe?g|svg)$/)),
      imagearray1: Object.keys(importAllImages(require.context('../../images/farms/Udaipur', false, /\.(png|jpe?g|svg)$/))),
